...
class KITTI(data.Dataset):
    def __init__(self, root_dir, split, cfg):
        ...
        # path configuration
        self.data_dir = os.path.join(root_dir, 'KITTI', 'object', 'testing' if split == 'test' else 'training')
...
if __name__ == '__main__':
    ...
    dataset = KITTI('/data/gkstmf616/dataset', 'train', cfg)
    ...
    for batch_idx, (inputs, targets, info) in enumerate(dataloader):
        ...
        img = (img * dataset.std + dataset.D) * 255
    ...
    for object in objects:
        _,calib_P2,_,_,_ = dataset.__getitem__(object)
        #box3d_pts_2d, _ = compute_box_3d(object,calib)
        #draw_projected_box3d(box3d_pts_2d,color=(255, 0, 0)) #rgb 빨강
